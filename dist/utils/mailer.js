...
const subscribeMailOption = async (email) => {
...
const sendForgetPasswordMailOption = async ({ email, username }, resetCode) => {
    const mailOptions = {
...
const emailVerificationMailOption = async (email, verificationLink) => {
    return {
...
const suspendedAccountMailOption = async (email, reason) => {
...
const createPropertyRequestMailOptions = async (to, name, email, phone, property_category, property_type, furnishing_status, country, state, number_of_bedrooms, number_of_bathrooms, budget, property_description, isAdmin) => {
