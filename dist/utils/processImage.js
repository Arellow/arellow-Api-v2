    ...
    return __awaiter(this, void 0, void 0, function* () {
        return circuitBreaker.execute(() => __awaiter(this, void 0, void 0, function* () {
            for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
                const start = Date.now();
                try {
                    // If file is a string (data URI), use it directly; else get content property
                    ...
                    const url = cloudinary_1.v2.url(result === null || result === void 0 ? void 0 : result.public_id, {
                        transformation: [
                            {
                                quality: "auto",
                                fetch_format: "auto",
...
uploadQueue.process((job) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Pass string data URI, not the DataURIParser object
        const file = dataUri.content || dataUri.toString();
        return yield uploadWithRetry(file);
    }
    catch (error) {
...
function processImage() {
    return __awaiter(this, arguments, void 0, function* (images = [], isProfile = false) {
        ...
        const imagesToUpload = jobs.map((job) => limit(() => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
