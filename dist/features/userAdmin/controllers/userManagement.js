...
const getPropertyDetails = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const property = yield listingService.getPropertyDetails(id);
        res.status(200).json({
            status: "success",
            data: property,
        });
...
const deleteProperty = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield listingService.deleteProperty(id);
        res.status(204).json({
            status: "success",
            data: null,
        });
