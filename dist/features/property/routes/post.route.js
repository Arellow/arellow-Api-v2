...
propertyRoutes.get("/featured", properties_1.featureProperties);
propertyRoutes.get("/recent", properties_1.recentPropertiesByUser);
...
propertyRoutes.post("/createproperty", auth_middleware_1.default, properties_1.createNewProperty);
