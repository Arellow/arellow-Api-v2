...
exports.createPropertyRequestMailOptions = exports.suspendedAccountMailOption = exports.emailVerificationMailOption = exports.sendForgetPasswordMailOption = exports.subscribeMailOption = void 0;
...
exports.subscribeMailOption = subscribeMailOption;
const sendForgetPasswordMailOption = (_a, resetCode_1) => __awaiter(void 0, [_a, resetCode_1], void 0, function* ({ email, username }, resetCode) {
    const mailOptions = {
...
exports.sendForgetPasswordMailOption = sendForgetPasswordMailOption;
const emailVerificationMailOption = (email, verificationLink) => __awaiter(void 0, void 0, void 0, function* () {
    return {
...
const createPropertyRequestMailOptions = (to, name, email, phone, property_category, property_type, furnishing_status, country, state, number_of_bedrooms, number_of_bathrooms, budget, property_description, isAdmin) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.createPropertyRequestMailOptions = createPropertyRequestMailOptions;
