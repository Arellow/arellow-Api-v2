...
const createCampaign = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const campaign = yield campaignService.createCampaign(userId, data);
...
const getCampaigns = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const campaigns = yield campaignService.getCampaigns(filter);
...
const getCampaign = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const campaign = yield campaignService.getCampaign(id);
...
const updateCampaign = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const campaign = yield campaignService.updateCampaign(userId, id, data);
...
const deleteCampaign = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield campaignService.deleteCampaign(id);
