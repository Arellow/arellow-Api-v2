    ...
    getAnalytics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const overview = yield this.prisma.campaign.aggregate({
                    _sum: {
                        clicks: true,
                        conversions: true,
                        spend: true,
                ...
                const hasData = ((_a = overview._sum) === null || _a === void 0 ? void 0 : _a.clicks) !== undefined &&
                    (((_b = overview._sum) === null || _b === void 0 ? void 0 : _b.clicks) || 0) > 0 ||
                    (((_c = overview._sum) === null || _c === void 0 ? void 0 : _c.conversions) || 0) > 0 ||
                    (((_d = overview._sum) === null || _d === void 0 ? void 0 : _d.spend) || 0) > 0;
                if (!hasData) {
                ...
                const trendData = yield this.prisma.campaign.groupBy({
                    by: ["startDate"],
                    _sum: {
                        clicks: true,
                        conversions: true,
                ...
                const topPerforming = yield this.prisma.campaign.groupBy({
                ...
                return {
                    overview: {
                        totalClicks: ((_e = overview._sum) === null || _e === void 0 ? void 0 : _e.clicks) || 0,
                        totalConversions: ((_f = overview._sum) === null || _f === void 0 ? void 0 : _f.conversions) || 0,
                        totalBudgetSpent: ((_g = overview._sum) === null || _g === void 0 ? void 0 : _g.spend) || 0,
                        trendData,
                    },
                    topPerforming,
                    performance,
                ...
                throw new appError_1.InternalServerError("Failed to fetch campaign analytics.");
            }
        });
    }
}
