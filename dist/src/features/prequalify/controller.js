...
const createPreQualification = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        const result = yield propertyService.createPreQualification(data, userId);
...
const getAllPreQualifications = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    ...
    try {
        const result = yield propertyService.getAllPreQualifications(userId, page ? parseInt(page) : 1, limit ? parseInt(limit) : 10);
...
const getPreQualificationById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    const { id } = req.params;
    if (!userId) {
    ...
    try {
        const result = yield propertyService.getPreQualificationById(id, userId);
        if (!result) {
            res.status(404).json({
                status: "failed",
...
const updatePreQualification = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    const { id } = req.params;
    const data = req.body;
    ...
    try {
        const result = yield propertyService.updatePreQualification(id, data, userId);
...
const deletePreQualification = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    const { id } = req.params;
    if (!userId) {
    ...
    try {
        yield propertyService.deletePreQualification(id, userId);
