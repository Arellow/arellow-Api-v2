...
const getRecentListings = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield dashboardService.getRecentListings();
        new response_util_1.default(200, true, "success", res, data);
    }
    catch (error) {
        next(error);
...
const performQuickAction = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { action, projectId } = req.body;
        const data = yield dashboardService.performQuickAction(action, projectId);
        new response_util_1.default(200, true, "success", res, data);
    }
    catch (error) {
        next(error);
