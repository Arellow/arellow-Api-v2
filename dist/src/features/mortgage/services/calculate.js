...
class ProjectService {
    ...
    calculateCustomMortgage(homeLocation, homePrice, downPayment) {
    ...
    saveMortgageDraft(homeLocation, homePrice, downPayment, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const draft = yield this.prisma.mortgageCalculationDraft.create({
                    data: {
                        home_location: homeLocation,
                        home_price: homePrice,
                        down_payment: downPayment,
                ...
                throw new appError_1.InternalServerError("Failed to save mortgage draft.");
            }
        });
    }
}
