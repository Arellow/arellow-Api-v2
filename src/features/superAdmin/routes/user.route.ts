...
import { addAdminSchema, createAdminSchema } from './user.validate';
...
userRoutes.post("/createadmin", validateSchema(createAdminSchema), authenticate, requireRole(UserRole.SUPER_ADMIN), createAdmin );
