...
import { AllActiveCampaigns, AllCampaigns, AllCampaignsRequest, campaignDashbroad, clickCampaign, createCampaign, deleteCampaign, getCampaignStats, requestCampaign, requestCampaignDetail, updateCampaign } from "../contollers/controller";
...
campaignRoutes.get("/requestcampaign/:id/detail", requestCampaignDetail);
campaignRoutes.get("/requestcampaign", authenticate, isSuspended, requireRole(UserRole.ADMIN, UserRole.SUPER_ADMIN), adminRequireRole("CAMPAIGN"), AllCampaignsRequest);
